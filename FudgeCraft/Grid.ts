namespace FudgeCraft {
    ...
    export class Grid extends Map<string, GridElement> {
        ...
        DestroyLayer(): void
        {
            ...
            let layerDepthArr: number[] = [layerDepth, layerDepth, layerDepth, layerDepth, layerDepth, layerDepth, layerDepth, layerDepth, layerDepth];
            let layerDepthArrMinus: number[] = [-layerDepth, -layerDepth, -layerDepth, -layerDepth, -layerDepth, -layerDepth, -layerDepth, -layerDepth, -layerDepth];
           
            for(let i = 0; i < layerDepth; i++){

                for(let axis = 0; axis <= 2; axis++)
                {
                    let XArray : number[] = [0,1,0,0,-1,1,-1,1,-1];
                    let YArray : number[] = [0,1,0,0,-1,1,-1,1,-1];
                    //let ZArray : number[] = [0,1,0,0,-1,1,-1,1,-1];
                    let ZArray : number[] = [0,0,1,-1,0,1,-1,-1,1];

                    let XArray1 : number[] = [0,1,0,0,-1,1,-1,1,-1];
                    let YArray1 : number[] = [0,1,0,0,-1,1,-1,1,-1];
                    //let ZArray1 : number[] = [0,1,0,0,-1,1,-1,1,-1];
                    let ZArray1 : number[] = [0,0,1,-1,0,1,-1,-1,1];
