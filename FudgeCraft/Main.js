...
(function (FudgeCraft) {
    ...
    let a = new FudgeCraft.ƒ.Color(0, 0, 0, 0);
    ...
    function hndLoad(_event) {
        ...
        let cmpLight = new FudgeCraft.ƒ.ComponentLight(new FudgeCraft.ƒ.LightDirectional(a));
        cmpLight.pivot.lookAt(new FudgeCraft.ƒ.Vector3(0.5, 1, 0.8));
        FudgeCraft.game.addComponent(cmpLight);
        let cmpLightAmbient = new FudgeCraft.ƒ.ComponentLight(new FudgeCraft.ƒ.LightAmbient(a));
