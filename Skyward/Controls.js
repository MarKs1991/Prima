...
(function (Skyward) {
    ...
    function processInput() {
        ...
        if (keysPressed[Skyward.f.KEYBOARD_CODE.A]) {
            Skyward.hare.act(Skyward.ACTION.WALK, Skyward.DIRECTION.LEFT);
            return;
        }
        if (keysPressed[Skyward.f.KEYBOARD_CODE.D]) {
            Skyward.hare.act(Skyward.ACTION.WALK, Skyward.DIRECTION.RIGHT);
            return;
        }
        Skyward.hare.act(Skyward.ACTION.IDLE);
    }
