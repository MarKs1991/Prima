...
(function (L14_ScrollerFoundation) {
    ...
    L14_ScrollerFoundation.SpriteFrame1 = SpriteFrame1;
    class Sprite1 {
        constructor(_name) {
            this.frames = [];
            this.name = _name;
        ...
        createFrame(_name, _texture, _framing, _rect, _resolutionQuad, _origin) {
            ...
            let frame = new L14_ScrollerFoundation.SpriteFrame();
    ...
    Sprite1.mesh = new ƒ.MeshSprite();
    L14_ScrollerFoundation.Sprite1 = Sprite1;
    class NodeSprite1 extends ƒ.Node {
        constructor(_name, _sprite) {
            super(_name);
            this.frameCurrent = 0;
            this.direction = 1;
            this.sprite = _sprite;
            this.cmpMesh = new ƒ.ComponentMesh(L14_ScrollerFoundation.Sprite.getMesh());
    ...
    L14_ScrollerFoundation.NodeSprite1 = NodeSprite1;
