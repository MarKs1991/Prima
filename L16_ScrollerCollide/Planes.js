...
(function (L16_ScrollerCollide) {
    ...
    class Planes extends f.Node {
        constructor(_name = "Planes") {
            ...
            this.update = (_event) => {
                ...
                if (this.cmpTransform.local.translation.x > 30) {
                    this.cmpTransform.local.translation = new f.Vector3(-30, Math.random() * L16_ScrollerCollide.levelData[0].PlatformNumber, 0);
                }
                //f.Debug.log(this.cmpTransform.local.translation.x);
            };
            this.addComponent(new f.ComponentTransform());
            let cmpMesh = new f.ComponentMesh(Planes.mesh);
            let nodeSprite = new L16_ScrollerCollide.NodeSprite("PlanesSprite", Planes.sprites[0]);
        ...
        static generateSprites(_txtImage) {
            Planes.sprites = [];
            let sprite = new L16_ScrollerCollide.Sprite("Planes");
